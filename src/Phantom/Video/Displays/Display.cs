...
public sealed class Display
{
    ...
    /// </summary>
    public string Name => SDLNative.SDL_GetDisplayName(Id);
    ...
    public RectInt Bounds
    {
        get
        {
            SDLException.ThrowIfFailed(SDLNative.SDL_GetDisplayBounds(Id, out RectInt bounds));
            return bounds;
        }
    }
    ...
    public RectInt UsableBounds
    {
        get
        {
            SDLException.ThrowIfFailed(SDLNative.SDL_GetDisplayUsableBounds(Id, out RectInt bounds));
            return bounds;
        }
    }
    ...
    /// </para>
    /// </remarks>
    public float ContentScale => SDLNative.SDL_GetDisplayContentScale(Id);
