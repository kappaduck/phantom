...
{
    /// <summary>
    /// Gets the reverse domain identifier of the application, e.g. com.kappaduck.phantom.demo.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets the human-readable name of the application, e.g. Phantom Demo.
    /// </summary>
    /// <remarks>
    ...
    /// This defaults to "SDL Application" if not set.
    /// </remarks>
